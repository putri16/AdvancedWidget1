...
public class MainActivity extends AppCompatActivity {
    ...
    private void doProses() {
        ...
        String hasil = "";
        for (int i = 1; i <= jumlah; i++) {
            LinearLayout llnaow = (LinearLayout) llAnak.findViewWithTag("Anak"+i);

            EditText etNama = (EditText) llnaow.findViewById(R.id.editTextNama);
            EditText etUmur = (EditText) llnaow.findViewById(R.id.editTextUmur);
